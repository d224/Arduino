...
bool DRV8825::setMode(uint16_t mode)
{
  switch (mode) 
  {
    case DRV8825_STEP_1x1:
        digitalWrite(_m0Pin, LOW);
        digitalWrite(_m1Pin, LOW);
        digitalWrite(_m2Pin, LOW);
        break;
    case DRV8825_STEP_1x2:
        digitalWrite(_m0Pin, HIGH);
        digitalWrite(_m1Pin, LOW);
        digitalWrite(_m2Pin, LOW);
        break;
    case DRV8825_STEP_1x4:
        digitalWrite(_m0Pin, LOW);
        digitalWrite(_m1Pin, HIGH);
        digitalWrite(_m2Pin, LOW);
        break;
    case DRV8825_STEP_1x8:
        digitalWrite(_m0Pin, HIGH);
        digitalWrite(_m1Pin, HIGH);
        digitalWrite(_m2Pin, LOW);
        break;
    case DRV8825_STEP_1x16:
        digitalWrite(_m0Pin, LOW);
        digitalWrite(_m1Pin, LOW);
        digitalWrite(_m2Pin, HIGH);
        break;
    case DRV8825_STEP_1x32:
        digitalWrite(_m0Pin, HIGH);
        digitalWrite(_m1Pin, HIGH);
        digitalWrite(_m2Pin, HIGH);
        break;
