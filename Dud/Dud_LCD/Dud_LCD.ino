...
void setup() {
  ...
  led.ClearTo(LED_OFF);  	led.Show();  
  led.ClearTo(LED_RED);  	led.Show();  
  led.ClearTo(LED_RED);  	led.Show();  delay(1000);
  led.ClearTo(LED_GREEN);  	led.Show();  
  led.ClearTo(LED_GREEN);  	led.Show();  delay(1000);
  led.ClearTo(LED_BLUE);  	led.Show();  
  led.ClearTo(LED_BLUE);  	led.Show();  delay(1000);
...
void NewSecHandler()
{
  ...
  if (bMainON_req != bMainON)
  {
    ...
    mqtt_udp_send( 0, "Dud/SetPower", (char*)tmp.c_str() );
  }
